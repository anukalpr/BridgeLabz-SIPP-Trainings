...
/*
 * SmartCityTransportSystem.java
 * Single-file demo of a Smart City Transport & Service Management System
 * Demonstrates Java 8 features: lambdas, method refs, default/static interface methods,
 * Stream API, collectors, functional & marker interfaces, and extensibility.
 *
 * To compile: javac SmartCityTransportSystem.java
 * To run:     java SmartCityTransportSystem
 */
